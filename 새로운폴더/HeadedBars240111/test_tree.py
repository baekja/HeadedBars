...
tree_regressor = DecisionTreeRegressor(random_state=42, max_depth= 4) # 2,4,5 중 4가 mse값 제일 작음 
...
print(f'Mean Squared Error(y_pred1): {mse}')
print(f'tree_regressor1 r2 score: {r2_test}')
...
plot_tree(tree_regressor, filled=True, rounded=True)
#plt.show()
